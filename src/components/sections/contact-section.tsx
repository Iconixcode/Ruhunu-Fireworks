...
export default function ContactSection() {
  ...
  const fieldHasError = (fieldName: keyof FormValues) => Boolean(formErrors[fieldName]);

  return (
    <section
      id="contact"
      className="w-full px-5 py-16 sm:px-8 sm:py-20 md:px-10 lg:px-14 xl:px-20"
            ...
            <form className="mt-7" onSubmit={handleSubmit} noValidate>
              <div className="grid gap-6 sm:grid-cols-2 sm:gap-6">
                <div className="w-full">
                  ...
                  <input
                    ...
                    className={`mt-3 w-full border-0 border-b bg-transparent pb-3 text-sm text-white outline-none transition placeholder:text-white/40 focus:border-white/70 ${fieldHasError("name") ? "border-red-400" : "border-white/25"}`}
                  />
                  {formErrors.name ? (
                ...
                <div className="w-full">
                  ...
                  <input
                    ...
                    className={`mt-3 w-full border-0 border-b bg-transparent pb-3 text-sm text-white outline-none transition placeholder:text-white/40 focus:border-white/70 ${fieldHasError("phone") ? "border-red-400" : "border-white/25"}`}
                  />
                  {formErrors.phone ? (
              ...
              <div className="mt-7 grid gap-6 sm:grid-cols-2 sm:gap-6">
                <div className="w-full">
                  ...
                  <input
                    ...
                    className={`mt-3 w-full border-0 border-b bg-transparent pb-3 text-sm text-white outline-none transition placeholder:text-white/40 focus:border-white/70 ${fieldHasError("email") ? "border-red-400" : "border-white/25"}`}
                  />
                  {formErrors.email ? (
                ...
                <div className="w-full">
                  ...
                  <input
                    ...
                    className={`mt-3 w-full border-0 border-b bg-transparent pb-3 text-sm text-white outline-none transition placeholder:text-white/40 focus:border-white/70 ${fieldHasError("subject") ? "border-red-400" : "border-white/25"}`}
                  />
                  {formErrors.subject ? (
                    <p className="mt-2 text-xs text-red-400">{formErrors.subject}</p>
                  ) : null}
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <textarea
                  ...
                  className={`mt-3 w-full resize-none border-0 border-b bg-transparent pb-3 text-sm text-white outline-none transition placeholder:text-white/40 focus:border-white/70 ${fieldHasError("message") ? "border-red-400" : "border-white/25"}`}
                />
                {formErrors.message ? (
                  <p className="mt-2 text-xs text-red-400">{formErrors.message}</p>
                ) : null}
              </div>
              ...
              <div className="mt-10 flex justify-center">
                {submitState === "success" || submitState === "error" ? (
                  <p
                    className={`text-center text-sm font-semibold sm:text-base ${submitState === "success" ? "text-emerald-300" : "text-red-400"}`}
                  >
                    {submitMessage}
                  </p>
                ) : (
