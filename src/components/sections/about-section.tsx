    ...
    >
      <Container>
        <div className="mx-auto w-full max-w-[1240px]">
          <div className="about-animate mb-10 text-center sm:mb-14">
          ...
          <div className="grid items-center gap-12 md:grid-cols-2 md:gap-12 lg:gap-16 xl:gap-20">
            ...
            <div className="w-full text-center md:text-left">
              <h3 className="about-animate mx-auto max-w-xl text-xl font-medium leading-tight sm:text-2xl md:mx-0 lg:text-[2rem] lg:leading-[1.18]">
                Crafting Brilliant Moments, Lighting Every Celebration
              </h3>

              <div className="about-animate mt-8 sm:mt-10">
              ...
              <div className="about-animate mx-auto mt-8 hidden w-full max-w-[560px] grid-cols-3 gap-4 sm:mt-10 sm:grid md:mx-0">
            ...
            <div className="flex w-full flex-col items-center md:items-end">
              <div className="about-animate order-1 flex w-full max-w-[320px] justify-center gap-3 sm:max-w-[360px] md:max-w-none md:justify-end md:gap-4">
                <Link
                  href="#fireworks"
              ...
              <div className="about-animate relative order-2 mt-8 h-[245px] w-full max-w-[320px] min-[430px]:h-[280px] min-[430px]:max-w-[360px] sm:h-[320px] sm:max-w-[430px] md:mt-6 md:h-[320px] md:max-w-[430px] lg:h-[360px] lg:max-w-[460px]">
                <Image
              ...
              {/* Mobile Stats */}
              <div className="about-animate order-3 mt-6 grid w-full max-w-[320px] grid-cols-3 gap-3 min-[430px]:max-w-[360px] sm:hidden">
                {stats.map((stat) => (
