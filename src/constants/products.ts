...
const productCatalog: ProductCatalog = {
  1: {
    ...
    image:
      "/images/all.jpg",
    galleryImages: [
      {  label: "Akasa Frame 100 Tharu",src: "https://res.cloudinary.com/dxaguv8d0/video/upload/v1778844319/fire2_xzai5i.mp4" },
      {  label: "Akasa Frame 50 Tharu",src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778844320/fire1_e04mx8.mp4" },
      {  label: "Akasa Frame 100 Wedi",src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857521/d491423186624050a3dbe397c9996a47-a10cd54e685cb5062a6827054db42a87-sd_cc6cws.mp4" },
      {  label: "Akasa Frame 50 Wedi",src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857955/4_Inch_Shell_Multi_o8nimy.mov" },
      {  label: "Akasa Frame 100 Tharu Mix Whistle",src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857955/4_Inch_Shell_Multi_o8nimy.mov" },
      {  label: "Akasa Frame 50 Tharu Mix Whistle",src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857955/4_Inch_Shell_Multi_o8nimy.mov" },
      {  label: "Akasa Frame 100 Wedi Mix Whistle",src: "" },
      {  label: "Akasa Frame 50 Wedi Mix Whistle",src: "" },
      {  label: "Akasa Frame 60 Whistle",src: "" },
      {  label: "Akasa Frame 80 Whistle",src: "" },
      {  label: "Akasa Frame 100 Whistle",src: "" },
      {  label: "Akasa Frame 30 Whistle",src: "" },
      {  label: "Akasa Frame 50Whistle",src: "" },
    ],
  },
  2: {
    name: "10 Shots",
    ...
    galleryImages: [
      {  label: "10 Shots Colour ",src: "" },
      {  label: "10 Shots Crackling ",src: "" },
      {  label: "10 Shots China ",src: "" },
    ],
  },
  3: {
    name: "20 Shouts",
    ...
    galleryImages: [
      {  label: "20 Shots Colour ",src: "" },
      {  label: "20 Shots Two in One ",src: "" },
    ],
  },
  4: {
    name: " Fountains",
    ...
    galleryImages: [
      {  label: "Colour Fountain ",src: "" },
      {  label: "Golden Fountain ",src: "" },
      {  label: "Silver Fountain ",src: "" },
      {  label: "Crackling Fountain",src: "" },
      {  label: "SPECIAL Fountain",src: "" },
    ],
  },
  5: {
    name: "Magic Shell",
    ...
    subpages: {
      '3-inch': {
        ...
        variants: ["3\"  White Colour Shell",
                   ...
                   "3\" Crackling Shell"],
        galleryImages: [
          { label: "3\"  White Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857964/3_Inch_Shell_White_1_oa9ky4.mov" },
          { label: "3\"  Silver Colour Shell", src: "" },
          { label: "3\"  Yellow Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778858001/3_Inch_Shel_Silver_fczqyy.mov" },
          {  label: "3\"  Green Colour Shell" ,src: "",},
          { label: "3\"  Red Colour Shell", src: "" },
          { label: "3\"  Blue Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857956/4Inch_Shell_Blue_untsbw.mov" },
          { label: "3\"  Multi Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857969/4_Inch_Shell_Multi_1_ijwxfi.mov" },
          { label: "3\"  Crackling Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857991/3Inch_Shell_Mix_mfp0e7.mov" },
        ],
      },
      '4-inch': {
        slug: "4-inch",
        ...
        variants: ["4\"  White Colour Shell",
                     ...
                     "4\" Crackling Shell"],
          galleryImages: [
            { label: "4\"  White Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857964/3_Inch_Shell_White_1_oa9ky4.mov" },
            { label: "4\"  Silver Colour Shell", src: "" },
            { label: "4\"  Yellow Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778858001/3_Inch_Shel_Silver_fczqyy.mov" },
            { label: "4\"  Green Colour Shell" , src: "", },
            { label: "4\"  Red Colour Shell", src: "" },
            { label: "4\"  Blue Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857956/4Inch_Shell_Blue_untsbw.mov" },
            { label: "4\"  Multi Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857969/4_Inch_Shell_Multi_1_ijwxfi.mov" },
            { label: "4\"  Crackling Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857969/4_Inch_Shell_Multi_1_ijwxfi.mov" },
          ],
      },
      '6-inch': {
        slug: "6-inch",
        ...
        variants: ["6\"  White Colour Shell",
                   ...
                   "6\" Crackling Shell"],
        galleryImages: [
          { label: "6\"  White Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857964/3_Inch_Shell_White_1_oa9ky4.mov" },
          { label: "6\"  Silver Colour Shell", src: "" },
          { label: "6\"  Yellow Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778858001/3_Inch_Shel_Silver_fczqyy.mov" },
          { label: "6\"  Green Colour Shell", src: "" },
          { label: "6\"  Red Colour Shell", src: "" },
          { label: "6\"  Blue Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857956/4Inch_Shell_Blue_untsbw.mov" },
          { label: "6\"  Multi Colour Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857969/4_Inch_Shell_Multi_1_ijwxfi.mov" },
          { label: "6\"  Crackling Shell", src: "https://res.cloudinary.com/dxaguv8d0/video/upload/q_auto/f_auto/v1778857969/4_Inch_Shell_Multi_1_ijwxfi.mov" },
        ],
      },
    },
    howItWorks:
